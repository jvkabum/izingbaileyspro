...
const GetWbotMessage = (ticket, messageId, totalMessages = 100) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!msgFound) {
            console.error(`Cannot found message within ${totalMessages} last messages`);
            return undefined;
        }
        return msgFound;
    }
