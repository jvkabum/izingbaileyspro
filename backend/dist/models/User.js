...
const UsersQueues_1 = __importDefault(require("./UsersQueues"));
...
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => Queue_1.default, () => UsersQueues_1.default, "userId", "queueId"),
    __metadata("design:type", Array)
], User.prototype, "queues", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => Contact_1.default, () => Ticket_1.default, "userId", "contactId"),
    __metadata("design:type", Array)
