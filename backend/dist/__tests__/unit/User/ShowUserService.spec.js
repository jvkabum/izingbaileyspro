...
describe("User", () => {
    ...
    it("should be able to find a user", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const user = yield (0, ShowUserService_1.default)(newUser.id, 1);
    ...
    it("should not be able to find a inexisting user", () => __awaiter(void 0, void 0, void 0, function* () {
        expect((0, ShowUserService_1.default)(faker_1.default.random.number(), 1)).rejects.toBeInstanceOf(AppError_1.default);
    }));
});
//# sourceMappingURL=ShowUserService.spec.js.map