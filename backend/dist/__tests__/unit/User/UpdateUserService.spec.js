...
describe("User", () => {
    ...
    it("should not be able to updated a inexisting user", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((0, UpdateUserService_1.default)({ userId, userData, tenantId: 1 })).rejects.toBeInstanceOf(AppError_1.default);
    }));
...
//# sourceMappingURL=UpdateUserService.spec.js.map