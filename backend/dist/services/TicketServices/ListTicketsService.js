...
const ListTicketsService = ({ searchParam = "", pageNumber = "1", status, date, showAll, userId, withUnreadMessages, queuesIds, isNotAssignedUser, includeNotQueueDefined, tenantId, profile }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    // check is admin
    const isAdminShowAll = showAll == "true" && profile === "admin";
    const isUnread = withUnreadMessages && withUnreadMessages == "true" ? "S" : "N";
    const isNotAssigned = isNotAssignedUser && isNotAssignedUser == "true" ? "S" : "N";
    ...
    const isExistsQueueTenant = (yield Queue_1.default.count({
        where: { tenantId }
    })) > 0
        ? "S"
        : "N";
...
`;
    ...
    let count = 0;
    let ticketsLength = 0;
    if (tickets === null || tickets === void 0 ? void 0 : tickets.length) {
